...
CREATE TABLE `adjudicacao` (
  ...
  `ID_FORNECEDOR` bigint(11) DEFAULT NULL,
  ...
  CONSTRAINT `FK_FORNECEDORiD_ADJ` FOREIGN KEY (`ID_FORNECEDOR`) REFERENCES `fornecedor` (`id_fornecedor`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `epas` VALUES (1,'Epas teste 1','1003',1,103,10101,'junta');
...
INSERT INTO `fornecedor` VALUES (1,'Teste nome','Teste num contrib 123456','Teste endereço','teste@email.com',NULL,1);
...
CREATE TABLE `programas_projectos` (
  ...
  `ASSOCIADO_INQUERITO` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`ID_PROGRAMAS_PROJECTOS`),
  KEY `FK_PROGRAMAS_PROJECTOS_ID_COMUNA` (`ID_COMUNA`),
  KEY `ID_USUARIO` (`ID_USUARIO`),
  KEY `FK_PROGRAMAS_PROJECTOS_ID_PROVINCIA` (`ID_PROVINCIA`),
  KEY `FK_PROGRAMAS_PROJECTOS__ID_MUNICIPIO` (`ID_MUNICIPIO`),
  ...
  CONSTRAINT `FK_PROGRAMAS_PROJECTOS__ID_MUNICIPIO` FOREIGN KEY (`ID_MUNICIPIO`) REFERENCES `municipio` (`id_municipio`),
...
INSERT INTO `programas_projectos` VALUES (1,10101,3,103,'2019-07-18','2019-12-03',1,'teste 2','projecto teste',123,'ROT (Recursos Ordinários do Tesouro)','ds',1),(2,10101,NULL,NULL,'2019-11-09','2019-11-16',1,'teste','projecto teste',234,'teste','fs',NULL);
...
-- Dump completed on 2019-12-03  1:59:14

...
export class HuamboComponent implements OnInit {
    ...
    onMapReady(map: L.Map) {
        ...
        info.update = function(props) {
            ...
            if (props) {
                switch (props.code) {
                    case 1009 :  this._div.innerHTML += '<b>Valor: ' + 67 + '</b><br />'; break; // Caála
                    ...
                    case 1007: this._div.innerHTML += '<b>Valor: ' + 0 + '</b><br />'; break; // Mungo
                    case 1005: this._div.innerHTML += '<b>Valor: ' + 0 + '</b><br />'; break; // Kathihungo
                    case 1001:  this._div.innerHTML += '<b>Valor: ' + 50 + '</b><br />';  break; // Huambo
                    case 1003 : this._div.innerHTML += '<b>Valor: ' + 100 + '</b><br />'; break; // Tchikala- Tcholohanga
                }
            }
        };
            ...
            geojson =  L.geoJSON(json, {
                style: (feature) => {
                    switch (feature.properties.nome) {
                        case 'Caála': return {color: 'white', weight: 2, opacity: 1, fillColor: '#BF8FF1', fillOpacity: 0.7}; // Caála
                        ...
                        case 'Tchikala-Tcholohanga': return {color: 'white', weight: 2, opacity: 1, fillColor: '#FCCC9E', fillOpacity: 0.7}; // Tchikala- Tcholohanga
                    }
                },

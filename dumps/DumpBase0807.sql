...
INSERT INTO `fornecedor` VALUES (1,'Teste nome','Teste num contrib 123456','Teste endereço','teste@email.com','Teste especialidade');
...
INSERT INTO `jhi_persistent_audit_event` VALUES (1,'admin','2019-07-06 10:13:49','AUTHENTICATION_SUCCESS'),(2,'admin','2019-07-06 10:42:43','AUTHENTICATION_SUCCESS'),(3,'admin','2019-07-07 11:08:40','AUTHENTICATION_SUCCESS'),(4,'admin','2019-07-07 11:42:45','AUTHENTICATION_SUCCESS'),(5,'admin','2019-07-07 15:12:40','AUTHENTICATION_SUCCESS'),(6,'admin','2019-07-07 18:38:53','AUTHENTICATION_SUCCESS'),(7,'admin','2019-07-07 19:15:38','AUTHENTICATION_SUCCESS'),(8,'admin','2019-07-07 20:47:04','AUTHENTICATION_SUCCESS'),(9,'admin','2019-07-08 15:37:08','AUTHENTICATION_SUCCESS');
...
CREATE TABLE `programas_projectos` (
  ...
  KEY `FK_PROGRAMAS_PROJECTOS_ID_USUARIO` (`ID_USUARIO`),
  CONSTRAINT `FK_PROGRAMAS_PROJECTOS_ID_COMUNA` FOREIGN KEY (`ID_COMUNA`) REFERENCES `comuna` (`id_comuna`),
  CONSTRAINT `FK_PROGRAMAS_PROJECTOS_ID_USUARIO` FOREIGN KEY (`ID_USUARIO`) REFERENCES `sisas_control_access`.`usuario` (`id_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `programas_projectos_log` (
  ...
  KEY `FK_PROGRAMAS_PROJECTOS_LOG_ID_USUARIO` (`ID_USUARIO`),
  ...
  CONSTRAINT `FK_PROGRAMAS_PROJECTOS_LOG_ID_USUARIO` FOREIGN KEY (`ID_USUARIO`) REFERENCES `sisas_control_access`.`usuario` (`id_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sistema_agua` (
  ...
  `NM_SISTEMA_AGUA` varchar(150) NOT NULL,
  `NM_FONTE_AGUA` varchar(150) NOT NULL,
  `LATITUDE` decimal(15,4) DEFAULT NULL,
  `LONGITUDE` decimal(15,4) DEFAULT NULL,
  `ALTITUDE` decimal(15,3) DEFAULT NULL,
  `NM_TP_FONTE` varchar(20) DEFAULT NULL,
  `NM_FONTE_AGUA_UTILIZADA` varchar(20) NOT NULL,
  `NM_TIPO_BOMBA` varchar(11) NOT NULL,
  ...
  `NM_TP_TRATAMENTO_AGUA` varchar(50) NOT NULL,
  `NM_TP_TRATAMENTO_PADRAO_UTILIZADO` varchar(50) NOT NULL,
  `NM_TP_TRATAMENTO_BASICO_UTILIZADO` varchar(50) NOT NULL,
  `EXISTE_AVARIA_SISTEMA_TRATAMENTO` varchar(50) NOT NULL,
  `EXISTE_MOTIVO_AUSENCIA_TRATAMENTO` varchar(50) NOT NULL,
  `NM_EQUIPAMENTOS_COM_AVARIA` varchar(50) NOT NULL,
  ...
  `NM_MODELO_BOMBA_MANUAL_UTILIZADA` varchar(50) NOT NULL,
...
INSERT INTO `sistema_agua` VALUES (3,1,10103,2,'teste','2019-07-20','2019-07-13','brasília',123,456,'4QUALITY','TECNOLOGIA',0,'Novo Teste','fonte nova',1234.0000,645.0000,7373.000,'4QUALITY','TECNOLOGIA','4QUALITY TE',98,67,45,54,4,1987,'13dasd','dasd','dsda55','dasdadfff',764.00,664.00,633.00,987.00,'dsdfdsfsklj',8787,98723,3242,844,22.00,'fsd','fsdf','sf','sdf','lksjdfds','sdf',99823,847.00,9834.00,8723.00,'kjhjkfds','df','ds'),(4,1,10501,1,'Anderson Soares','2019-07-03','2019-07-08','Dublin',98,76,'Dispersa','Urbana',0,'Test2 ','Lagoa',124.0000,989.0000,767.000,'Subterrânea','Lagoa','Diesel',5,8,8,8,8,1945,'Avaria Mecânica','Bomba deixou de Funcionar','Falta de Fundos para Reparação','Um mês',6.00,9999.00,878.00,987.00,'metal',32,323,323,323,323.00,'Tratamento Básico-Cloro','Coagulação, floculação, decantação,filtração','Cloro Líquido','Sim, Sistema Avariado','Falta de Conhecimento','Electroagitadores',797,876.00,876.00,3.00,'Furo','Volanta','Solar');
...
-- Dump completed on 2019-07-08 22:15:01

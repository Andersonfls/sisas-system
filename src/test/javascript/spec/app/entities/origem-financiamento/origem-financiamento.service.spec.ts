...
describe('Service Tests', () => {
    ...
    describe('OrigemFinanciamento Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(OrigemFinanciamentoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/origem-financiamentos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return OrigemFinanciamento', () => {

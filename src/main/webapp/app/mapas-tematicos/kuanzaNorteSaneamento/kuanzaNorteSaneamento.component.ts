        ...
        info.update = function(props) {
            ...
            if (props) {
                switch (props.code) {
                    ...
                    case 511: this._div.innerHTML += '<b>Valor: ' + 1 + '% </b><br />'; break; // Luanda
                    case 507: this._div.innerHTML += '<b>Valor: ' + 0 + '% </b><br />'; break; // Kuanza Norte
                    case 503: this._div.innerHTML += '<b>Valor: ' + 0 + '% </b><br />'; break; // Kuanza Sul
                    case 501: this._div.innerHTML += '<b>Valor: ' + 26 + '% </b><br />'; break; // Malanje
                    case 505: this._div.innerHTML += '<b>Valor: ' + 4 + '% </b><br />'; break; // Lunda Norte
                    case 515: this._div.innerHTML += '<b>Valor: ' + 6 + '% </b><br />'; break; // Benguela
                    ...
                    geojson =  L.geoJSON(json, {
                        style: (feature) => {
                            switch (feature.properties.code) {
                                case 509: return {color: 'white', weight: 2, opacity: 1, fillColor: '#FEFDA1', fillOpacity: 0.7};
                                ...
                                case 501: return {color: 'white', weight: 2, opacity: 1, fillColor: '#A2D1FB', fillOpacity: 0.7};

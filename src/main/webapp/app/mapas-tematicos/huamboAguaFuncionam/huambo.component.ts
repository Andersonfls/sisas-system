        ...
        info.update = function(props) {
            ...
            if (props) {
                switch (props.code) {
                    ...
                    case 1015 :  this._div.innerHTML += '<b>Valor: ' + 100 + '% </b><br />'; break; // Longonjo
                    case 1021: this._div.innerHTML += '<b>Valor: ' + 0 + '% </b><br />'; break; // Tcninjenje
                    case 1011: this._div.innerHTML += '<b>Valor: ' + 100 + '% </b><br />'; break; // Ukuma
                    case 1019 : this._div.innerHTML += '<b>Valor: ' + 80 + '% </b><br />'; break; // Libduimbali
                    case 1013: this._div.innerHTML += '<b>Valor: ' + 0 + '% </b><br />'; break; // Ekuma
                    case 1007: this._div.innerHTML += '<b>Valor: ' + 40 + '% </b><br />'; break; // Mungo
                    case 1005: this._div.innerHTML += '<b>Valor: ' + 0 + '% </b><br />'; break; // Kathihungo
                    case 1001:  this._div.innerHTML += '<b>Valor: ' + 0 + '% </b><br />';  break; // Huambo
                    case 1003 : this._div.innerHTML += '<b>Valor: ' + 75 + '% </b><br />'; break; // Tchikala- Tcholohanga
                    case 1017 : this._div.innerHTML += '<b>Valor: ' + 100 + '% </b><br />'; break; // Tchikala- Tcholohanga
                }
            }
        };
            ...
            geojson =  L.geoJSON(json, {
                style: (feature) => {
                    switch (feature.properties.nome) {
                        ...
                        case 'Longonjo': return {color: 'white', weight: 2, opacity: 1, fillColor: '#FCCC9E', fillOpacity: 0.7}; // Longonjo
                        ...
                        case 'Londuimbali': return {color: 'white', weight: 2, opacity: 1, fillColor: '#BF8FF1', fillOpacity: 0.7}; // Libduimbali
                        ...
                        case 'Tchikala-Tcholohanga': return {color: 'white', weight: 2, opacity: 1, fillColor: '#BF8FF1', fillOpacity: 0.7}; // Tchikala- Tcholohanga
                    }
                },

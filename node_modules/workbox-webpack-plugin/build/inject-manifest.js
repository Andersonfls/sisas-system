  ...
  (0, _createClass3.default)(InjectManifest, [{
    ...
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(compilation, readFile) {
        var workboxSWImports, modulePathPrefix, entries, importScriptsArray, sanitizedConfig, _ref2, manifestEntries, warnings, manifestString, manifestAsset, manifestHash, manifestFilename, originalSWString, importScriptsString, setConfigString, postInjectionSWString;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 17:
                ...
                importScriptsArray.push((compilation.options.output.publicPath || '') + manifestFilename);
    ...
    value: function apply(compiler) {
      ...
      if ('hooks' in compiler) {
        ...
        compiler.hooks.emit.tapPromise(this.constructor.name, function (compilation) {
          return _this.handleEmit(compilation, compiler.inputFileSystem._readFile);
        });
      } else {

...
describe('Service Tests', () => {
    ...
    describe('IndicadorProducaoLog Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(IndicadorProducaoLogService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/indicador-producao-logs';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return IndicadorProducaoLog', () => {

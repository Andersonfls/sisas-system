...
public class IndicadorProducaoProvincia implements Serializable {
    ...
    public IndicadorProducaoProvincia idUsuario(Long idUsuario) {
    ...
    public IndicadorProducaoProvincia dtLancamento(LocalDate dtLancamento) {
    ...
    public IndicadorProducaoProvincia dtUltimaAlteracao(LocalDate dtUltimaAlteracao) {
    ...
    public IndicadorProducaoProvincia qtdPopulacaoCobertaInfraestrutura(BigDecimal qtdPopulacaoCobertaInfraestrutura) {
    ...
    public IndicadorProducaoProvincia qtdFontanariosChafarisesOperacionais(BigDecimal qtdFontanariosChafarisesOperacionais) {
    ...
    public IndicadorProducaoProvincia qtdMediaHorasDistribuicaoDiaria(BigDecimal qtdMediaHorasDistribuicaoDiaria) {
    ...
    public IndicadorProducaoProvincia qtdMediaHorasParagem(BigDecimal qtdMediaHorasParagem) {
    ...
    public IndicadorProducaoProvincia qtdMediaHorasInterrupcaoFaltaEnergia(BigDecimal qtdMediaHorasInterrupcaoFaltaEnergia) {
    ...
    public IndicadorProducaoProvincia qtdVolumeAguaCaptada(BigDecimal qtdVolumeAguaCaptada) {
    ...
    public IndicadorProducaoProvincia qtdVolumeAguaTratada(BigDecimal qtdVolumeAguaTratada) {
    ...
    public IndicadorProducaoProvincia qtdVolumeAguaDistribuida(BigDecimal qtdVolumeAguaDistribuida) {
    ...
    public IndicadorProducaoProvincia qtdConsumoEnergia(BigDecimal qtdConsumoEnergia) {
    ...
    public IndicadorProducaoProvincia qtdConsumoCombustivel(BigDecimal qtdConsumoCombustivel) {
    ...
    public IndicadorProducaoProvincia qtdConsumoHipocloritroCalcio(BigDecimal qtdConsumoHipocloritroCalcio) {
    ...
    public IndicadorProducaoProvincia qtdConsumoSulfatoAluminio(BigDecimal qtdConsumoSulfatoAluminio) {
    ...
    public IndicadorProducaoProvincia qtdConsumoHidroxidoCalcio(BigDecimal qtdConsumoHidroxidoCalcio) {
    ...
    public IndicadorProducaoProvincia qtdReparoCaptacaoEtas(Long qtdReparoCaptacaoEtas) {
    ...
    public IndicadorProducaoProvincia qtdReparoAdutoras(Long qtdReparoAdutoras) {
    ...
    public IndicadorProducaoProvincia qtdReparoRedeDistribuicao(Long qtdReparoRedeDistribuicao) {
    ...
    public IndicadorProducaoProvincia qtdReparoRamais(Long qtdReparoRamais) {
    ...
    public IndicadorProducaoProvincia qtdManutencaoCurativa(Long qtdManutencaoCurativa) {
    ...
    public IndicadorProducaoProvincia qtdManutencaoPreventiva(Long qtdManutencaoPreventiva) {
    ...
    public IndicadorProducaoProvincia qtdManutencaoVerificadoSolicitado(Long qtdManutencaoVerificadoSolicitado) {
    ...
    public IndicadorProducaoProvincia qtdReservatorioLavado(Long qtdReservatorioLavado) {
    ...
    public IndicadorProducaoProvincia qtdFuncionarios(Long qtdFuncionarios) {
    ...
    public IndicadorProducaoProvincia qtdFuncionariosEfectivos(Long qtdFuncionariosEfectivos) {
    ...
    public IndicadorProducaoProvincia qtdFuncionariosContratados(Long qtdFuncionariosContratados) {
    ...
    public IndicadorProducaoProvincia qtdFuncionariosOutrasEntidades(Long qtdFuncionariosOutrasEntidades) {
    ...
    public IndicadorProducaoProvincia qtdNovasLigacoesNovosContratos(Long qtdNovasLigacoesNovosContratos) {
    ...
    public IndicadorProducaoProvincia qtdNovasLigacoesDomesticasNovosContratos(Long qtdNovasLigacoesDomesticasNovosContratos) {
    ...
    public IndicadorProducaoProvincia qtdLigacoesIlegaisRegularizadas(Long qtdLigacoesIlegaisRegularizadas) {
    ...
    public IndicadorProducaoProvincia qtdLigacoesFechadas(Long qtdLigacoesFechadas) {
    ...
    public IndicadorProducaoProvincia qtdCortes(Long qtdCortes) {
    ...
    public IndicadorProducaoProvincia qtdReligacoes(Long qtdReligacoes) {
    ...
    public IndicadorProducaoProvincia qtdLigacoesActivas(Long qtdLigacoesActivas) {
    ...
    public IndicadorProducaoProvincia qtdLigacoesDomesticasActivas(Long qtdLigacoesDomesticasActivas) {
    ...
    public IndicadorProducaoProvincia qtdLigacoesFacturadasBaseLeiturasReais(Long qtdLigacoesFacturadasBaseLeiturasReais) {
    ...
    public IndicadorProducaoProvincia qtdLigacoesFacturadasBaseEstimativasAvenca(Long qtdLigacoesFacturadasBaseEstimativasAvenca) {
    ...
    public IndicadorProducaoProvincia qtdVolumeAguaFacturada(BigDecimal qtdVolumeAguaFacturada) {
    ...
    public IndicadorProducaoProvincia qtdVolumeTotalFacturadaLigacoesDomesticas(BigDecimal qtdVolumeTotalFacturadaLigacoesDomesticas) {
    ...
    public IndicadorProducaoProvincia qtdVolumeFacturadoBaseLeituraReais(BigDecimal qtdVolumeFacturadoBaseLeituraReais) {
    ...
    public IndicadorProducaoProvincia vlrTotalFacturado(BigDecimal vlrTotalFacturado) {
    ...
    public IndicadorProducaoProvincia vlrFacturasCanceladasNotasCreditos(BigDecimal vlrFacturasCanceladasNotasCreditos) {
    ...
    public IndicadorProducaoProvincia vlrRealFacturado(BigDecimal vlrRealFacturado) {
    ...
    public IndicadorProducaoProvincia vlrTotalCobrado(BigDecimal vlrTotalCobrado) {
    ...
    public IndicadorProducaoProvincia qtdReclamacoes(Long qtdReclamacoes) {
    ...
    public IndicadorProducaoProvincia qtdReclamacoesRespondidasMenorIgualCincoDias(Long qtdReclamacoesRespondidasMenorIgualCincoDias) {
    ...
    public IndicadorProducaoProvincia qtdReclamacoesRespondidasMaisCincoMenosVinteDias(Long qtdReclamacoesRespondidasMaisCincoMenosVinteDias) {
    ...
    public IndicadorProducaoProvincia qtdReclamacoesRespondidasMaiorIgualVinteDias(Long qtdReclamacoesRespondidasMaiorIgualVinteDias) {
    ...
    public IndicadorProducaoProvincia vlrCustoPessoal(BigDecimal vlrCustoPessoal) {
    ...
    public IndicadorProducaoProvincia vlrCustoFse(BigDecimal vlrCustoFse) {
    ...
    public IndicadorProducaoProvincia vlrCustoEnergia(BigDecimal vlrCustoEnergia) {
    ...
    public IndicadorProducaoProvincia vlrCustoManutencao(BigDecimal vlrCustoManutencao) {
    ...
    public IndicadorProducaoProvincia vlrCustoReagentes(BigDecimal vlrCustoReagentes) {
    ...
    public IndicadorProducaoProvincia vlrCustoDestinoFinalLamas(BigDecimal vlrCustoDestinoFinalLamas) {
    ...
    public IndicadorProducaoProvincia vlrCustoOperacionaisOpex(BigDecimal vlrCustoOperacionaisOpex) {
    ...
    public IndicadorProducaoProvincia vlrCustoAmortizaAnualInvestOpCapex(BigDecimal vlrCustoAmortizaAnualInvestOpCapex) {
    ...
    public IndicadorProducaoProvincia vlrCustoTotaisCapexOpex(BigDecimal vlrCustoTotaisCapexOpex) {
    ...
    public IndicadorProducaoProvincia qtdCaptacoes(Long qtdCaptacoes) {
    ...
    public IndicadorProducaoProvincia qtdEtas(Long qtdEtas) {
    ...
    public IndicadorProducaoProvincia qtdReservatorios(Long qtdReservatorios) {
    ...
    public IndicadorProducaoProvincia qtdEstacoesElevatorias(Long qtdEstacoesElevatorias) {
    ...
    public IndicadorProducaoProvincia qtdComprimentoAdutoras(BigDecimal qtdComprimentoAdutoras) {
    ...
    public IndicadorProducaoProvincia qtdComprimentoRedes(BigDecimal qtdComprimentoRedes) {
    ...
    public IndicadorProducaoProvincia qtdComprimentoRamais(BigDecimal qtdComprimentoRamais) {
    ...
    public IndicadorProducaoProvincia qtdAcoesFormacaoMoPlaneadas(Long qtdAcoesFormacaoMoPlaneadas) {
    ...
    public IndicadorProducaoProvincia qtdAcoesFormacaoMmsPlaneadas(Long qtdAcoesFormacaoMmsPlaneadas) {
    ...
    public IndicadorProducaoProvincia qtdAcoesFormacaoCmpPlaneadas(Long qtdAcoesFormacaoCmpPlaneadas) {
    ...
    public IndicadorProducaoProvincia qtdAcoesFormacaoSoftwareFornecidosPlanejadas(Long qtdAcoesFormacaoSoftwareFornecidosPlanejadas) {
    ...
    public IndicadorProducaoProvincia qtdAcoesFormacaoMoRealizadas(Long qtdAcoesFormacaoMoRealizadas) {
    ...
    public IndicadorProducaoProvincia qtdAcoesFormacaoMmsRealizadas(Long qtdAcoesFormacaoMmsRealizadas) {
    ...
    public IndicadorProducaoProvincia qtdAcoesFormacaoCmpRealizadas(Long qtdAcoesFormacaoCmpRealizadas) {
    ...
    public IndicadorProducaoProvincia qtdAcoesFormacaoSoftwareFornecidosRealizadas(Long qtdAcoesFormacaoSoftwareFornecidosRealizadas) {
    ...
    public IndicadorProducaoProvincia qtdAcoesFormacaoRealizadas(Long qtdAcoesFormacaoRealizadas) {
    ...
    public IndicadorProducaoProvincia qtdManuaisMoPrevistos(Long qtdManuaisMoPrevistos) {
    ...
    public IndicadorProducaoProvincia qtdManuaisMmsPrevistos(Long qtdManuaisMmsPrevistos) {
    ...
    public IndicadorProducaoProvincia qtdManuaisCmpPrevistos(Long qtdManuaisCmpPrevistos) {
    ...
    public IndicadorProducaoProvincia qtdManuaisPrevistos(Long qtdManuaisPrevistos) {
    ...
    public IndicadorProducaoProvincia qtdAcoesManuaisMoRealizadas(Long qtdAcoesManuaisMoRealizadas) {
    ...
    public IndicadorProducaoProvincia qtdManuaisMmsRealizadas(Long qtdManuaisMmsRealizadas) {
    ...
    public IndicadorProducaoProvincia qtdManuaisCmpRealizadas(Long qtdManuaisCmpRealizadas) {
    ...
    public IndicadorProducaoProvincia qtdManuaisRealizados(Long qtdManuaisRealizados) {
    ...
    public IndicadorProducaoProvincia idSituacao(Situacao situacao) {
    ...
    public IndicadorProducaoProvincia idSistemaAgua(SistemaAgua sistemaAgua) {
    ...
    public IndicadorProducaoProvincia idComuna(Comuna comuna) {
        this.comuna = comuna;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        IndicadorProducaoProvincia indicadorProducao = (IndicadorProducaoProvincia) o;

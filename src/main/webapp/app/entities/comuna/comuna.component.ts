...
currentAccount: any;
    ...
    loadAll() {
        this.comunaService.query({
            ...
            sort: this.sort()}).subscribe(
                (res: HttpResponse<Comuna[]>) => this.onSuccess(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/comuna'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    onChangeNome() {
        if (this.nome === undefined) {
            ...
            this.comunaService.queryUserNome({
                page: this.page - 1,
                size: this.itemsPerPage,
                nome: this.nome
            }).subscribe((res) => {

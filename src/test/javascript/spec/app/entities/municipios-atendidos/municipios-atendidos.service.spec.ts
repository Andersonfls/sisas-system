...
describe('Service Tests', () => {
    ...
    describe('MunicipiosAtendidos Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(MunicipiosAtendidosService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/municipios-atendidos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return MunicipiosAtendidos', () => {

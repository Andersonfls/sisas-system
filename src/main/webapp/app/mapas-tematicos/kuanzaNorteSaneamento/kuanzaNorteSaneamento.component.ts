                    ...
                    geojson =  L.geoJSON(json, {
                        style: (feature) => {
                            switch (feature.properties.code) {
                                case 1: return {color: 'white', weight: 2, opacity: 1, fillColor: '#FEFDA1', fillOpacity: 0.7};
                                ...
                                case 7: return {color: 'white', weight: 2, opacity: 1, fillColor: '#A2D1FB', fillOpacity: 0.7};

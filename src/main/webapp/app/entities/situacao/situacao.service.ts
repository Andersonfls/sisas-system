...
export class SituacaoService {
    ...
    queryUserNome(req: any): Observable<HttpResponse<Situacao[]>> {
        const params: HttpParams = createRequestOption(req);

        const requestURL = SERVER_API_URL + 'api/situacaos/nomeFiltro';

        return this.http.get<Situacao[]>(requestURL, {
            params,
            observe: 'response'
        });
    }

...
describe('Service Tests', () => {
    ...
    describe('ProgramasProjectos Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ProgramasProjectosService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/programas-projectos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ProgramasProjectos', () => {

...
describe('Service Tests', () => {
    ...
    describe('ProgramasProjectosLog Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ProgramasProjectosLogService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/programas-projectos-logs';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ProgramasProjectosLog', () => {
